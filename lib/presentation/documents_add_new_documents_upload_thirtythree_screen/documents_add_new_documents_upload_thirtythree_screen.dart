...
class DocumentsAddNewDocumentsUploadThirtythreeScreen extends GetWidget<DocumentsAddNewDocumentsUploadThirtythreeController> {
  @override
                  ...
                  Container(
                      ...
                      child: Padding(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, mainAxisSize: MainAxisSize.min, children: [
                            ...
                            Padding(padding: getPadding(left: 38, top: 5, bottom: 2), child: Text("lbl_photo2_png".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoBold16.copyWith(letterSpacing: 1.92, height: 1.00)))
                          ]))),

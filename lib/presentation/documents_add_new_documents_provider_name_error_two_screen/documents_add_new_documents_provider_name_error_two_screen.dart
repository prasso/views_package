import '../documents_add_new_documents_provider_name_error_two_screen/widgets/listvectorfour2_item_widget.dart';
...
class DocumentsAddNewDocumentsProviderNameErrorTwoScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameErrorTwoController> {
                      ...
                      Expanded(
                        ...
                        Container(
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentySevenController2, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), alignment: Alignment.center),
                              CustomTextFormField(
                                  width: 358,
                                  focusNode: FocusNode(),
                                  controller: controller.frameTwentySixController2,
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                              Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.documentsAddNewDocumentsProviderNameErrorTwoModelObj.value.listvectorfour2ItemList.length,
                                      itemBuilder: (context, index) {
                                        Listvectorfour2ItemModel model = controller.documentsAddNewDocumentsProviderNameErrorTwoModelObj.value.listvectorfour2ItemList[index];
                                        return Listvectorfour2ItemWidget(model);
                                      }))),
                              Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                    ...
                                    CustomTextFormField(width: 96, focusNode: FocusNode(), controller: controller.buttonlargeSixController2, hintText: "lbl_return".tr, variant: TextFormFieldVariant.OutlineBluegray400, padding: TextFormFieldPadding.PaddingTB14, fontStyle: TextFormFieldFontStyle.SFProDisplayRegular165, textInputAction: TextInputAction.done)
                                  ])),
                              Padding(

...
class Listtrash1ItemWidget extends StatelessWidget {
  Listtrash1ItemWidget(this.listtrash1ItemModelObj);

  Listtrash1ItemModel listtrash1ItemModelObj;

  var controller = Get.find<DocumentsAddNewDocumentsUploadSixController>();

...
class DocumentsAddNewDocumentsProviderNameScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameController> {
  @override
                ...
                child: SingleChildScrollView(
                  ...
                  Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                        ...
                        CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentyFourController1, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), textInputAction: TextInputAction.done, alignment: Alignment.center),
                        Align(

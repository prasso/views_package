import '../documents_add_new_documents_provider_name_error_one_screen/widgets/listvectorfour1_item_widget.dart';
import 'controller/documents_add_new_documents_provider_name_error_one_controller.dart';
import 'models/listvectorfour1_item_model.dart';
...
class DocumentsAddNewDocumentsProviderNameErrorOneScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameErrorOneController> {
                      ...
                      Expanded(
                        ...
                        Container(
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentySevenController1, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), alignment: Alignment.center),
                              CustomTextFormField(
                                  width: 358,
                                  focusNode: FocusNode(),
                                  controller: controller.frameTwentySixController1,
                            ...
                            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                              Padding(
                                  ...
                                  child: Obx(() => ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.documentsAddNewDocumentsProviderNameErrorOneModelObj.value.listvectorfour1ItemList.length,
                                      itemBuilder: (context, index) {
                                        Listvectorfour1ItemModel model = controller.documentsAddNewDocumentsProviderNameErrorOneModelObj.value.listvectorfour1ItemList[index];
                                        return Listvectorfour1ItemWidget(model);
                                      }))),
                              Padding(
                                  ...
                                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                    ...
                                    CustomTextFormField(width: 96, focusNode: FocusNode(), controller: controller.buttonlargeSixController1, hintText: "lbl_return".tr, variant: TextFormFieldVariant.OutlineBluegray400, padding: TextFormFieldPadding.PaddingTB14, fontStyle: TextFormFieldFontStyle.SFProDisplayRegular165, textInputAction: TextInputAction.done)
                                  ])),
                              Padding(

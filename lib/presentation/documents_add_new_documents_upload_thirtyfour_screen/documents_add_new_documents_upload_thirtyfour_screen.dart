...
class DocumentsAddNewDocumentsUploadThirtyfourScreen extends GetWidget<DocumentsAddNewDocumentsUploadThirtyfourController> {
  @override
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                  ...
                                  Container(
                                      ...
                                      child: Row(
                                          ...
                                          children: [ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(16.00)), child: CommonImageView(imagePath: ImageConstant.imgUpload51, height: getVerticalSize(314.00), width: getHorizontalSize(220.00))), CustomIconButton(height: 48, width: 48, margin: getMargin(left: 504, top: 133, right: 156, bottom: 133), padding: IconButtonPadding.PaddingAll12, child: CommonImageView(svgPath: ImageConstant.imgGrid))]))
                                ])),
                            Align(alignment: Alignment.center, child: Padding(padding: getPadding(left: 16, top: 33, right: 16), child: Text("msg_filename3_page".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoRegular16Gray801.copyWith(letterSpacing: 1.92, height: 1.00)))),

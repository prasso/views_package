...
class DocumentsAddNewDocumentsUploadThirteenScreen extends GetWidget<DocumentsAddNewDocumentsUploadThirteenController> {
  @override
                  ...
                  Expanded(
                    ...
                    Container(
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Padding(padding: getPadding(left: 16, top: 40, right: 16), child: Text("msg_upload_up_to_10".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoBold16Gray800.copyWith(letterSpacing: 1.92, height: 1.00))),
                          Container(

...
class Listframe36419ItemWidget extends StatelessWidget {
  Listframe36419ItemWidget(this.listframe36419ItemModelObj);

  Listframe36419ItemModel listframe36419ItemModelObj;

  var controller = Get.find<ActivitySearchButtonController>();

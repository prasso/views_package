...
class DocumentsAddNewDocumentsUploadTwentyeightScreen extends GetWidget<DocumentsAddNewDocumentsUploadTwentyeightController> {
  @override
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  Container(
                      ...
                      child: Padding(
                          padding: getPadding(left: 20, top: 26, right: 94, bottom: 26),
                          child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, mainAxisSize: MainAxisSize.max, children: [
                            ...
                            Padding(padding: getPadding(left: 38, top: 5, bottom: 2), child: Text("msg_filename1_page".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoBold16.copyWith(letterSpacing: 1.92, height: 1.00)))
                          ]))),
                  CommonImageView(imagePath: ImageConstant.imgFrame10, height: getVerticalSize(724.00), width: getHorizontalSize(390.00))
                ]))))));
  }

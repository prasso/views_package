...
class DocumentsAddNewDocumentsProviderNameThreeScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameThreeController> {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentyFourController4, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), textInputAction: TextInputAction.done),
                  Container(

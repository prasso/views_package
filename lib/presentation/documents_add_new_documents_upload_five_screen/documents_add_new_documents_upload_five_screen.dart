...
class DocumentsAddNewDocumentsUploadFiveScreen extends GetWidget<DocumentsAddNewDocumentsUploadFiveController> {
  @override
                          ...
                          Align(
                              ...
                              child: Container(
                                  ...
                                  child: Row(
                                      ...
                                      children: [Padding(padding: getPadding(left: 10, top: 14, bottom: 14), child: CommonImageView(svgPath: ImageConstant.imgWarning, height: getSize(20.00), width: getSize(20.00))), Padding(padding: getPadding(left: 18, top: 17, bottom: 14), child: Text("msg_add_your_docume".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoBold16Gray800.copyWith(letterSpacing: 1.92, height: 1.00)))]))),
                          Align(
                              alignment: Alignment.center,
                              child: Container(

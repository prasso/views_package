...
class Listtrash3ItemWidget extends StatelessWidget {
  Listtrash3ItemWidget(this.listtrash3ItemModelObj);

  Listtrash3ItemModel listtrash3ItemModelObj;

  var controller = Get.find<DocumentsAddNewDocumentsUploadSixteenController>();

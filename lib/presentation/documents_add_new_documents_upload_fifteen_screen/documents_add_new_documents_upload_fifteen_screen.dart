...
class DocumentsAddNewDocumentsUploadFifteenScreen extends GetWidget<DocumentsAddNewDocumentsUploadFifteenController> {
  @override
                                  ...
                                  child: Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.end, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                        ...
                                        Container(
                                            ...
                                            margin: getMargin(left: 16, right: 472),
                                            child: Stack(alignment: Alignment.centerLeft, children: [
                                              Align(alignment: Alignment.centerLeft, child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(16.00)), child: CommonImageView(imagePath: ImageConstant.imgUpload4, height: getVerticalSize(314.00), width: getHorizontalSize(220.00)))),
                                              Align(
                                                  alignment: Alignment.centerLeft,
                                                  child: Padding(
                                                      padding: getPadding(left: 16, right: 16),
                                                      child: Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
                                                        CustomIconButton(height: 48, width: 48, margin: getMargin(top: 133, bottom: 133), child: CommonImageView(svgPath: ImageConstant.imgArrowright)),
                                                        Padding(
                                                            padding: getPadding(left: 172),
                                                            child: Row(
                                                                crossAxisAlignment: CrossAxisAlignment.center,
                                                                mainAxisSize: MainAxisSize.min,
                                                                children: [ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(16.00)), child: CommonImageView(imagePath: ImageConstant.imgUpload6, height: getVerticalSize(314.00), width: getHorizontalSize(220.00))), Padding(padding: getPadding(left: 16), child: CommonImageView(imagePath: ImageConstant.imgUpload3, height: getVerticalSize(314.00), width: getHorizontalSize(220.00)))]))
                                                      ])))
                                            ]))
                                      ]))),
                              Align(alignment: Alignment.center, child: Padding(padding: getPadding(left: 10, top: 33, right: 10), child: Text("msg_filename1_page2".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoRegular16Gray801.copyWith(letterSpacing: 1.92, height: 1.00)))),
                              CustomButton(width: 358, text: "msg_submit_for_revi".tr.toUpperCase(), margin: getMargin(left: 10, top: 30, right: 10, bottom: 34), alignment: Alignment.center)
                            ]))),
                    Container(

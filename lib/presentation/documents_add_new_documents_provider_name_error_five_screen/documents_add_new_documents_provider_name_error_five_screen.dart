import '../documents_add_new_documents_provider_name_error_five_screen/widgets/listvectorfour5_item_widget.dart';
import 'controller/documents_add_new_documents_provider_name_error_five_controller.dart';
import 'models/listvectorfour5_item_model.dart';
...
class DocumentsAddNewDocumentsProviderNameErrorFiveScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameErrorFiveController> {
                  ...
                  Expanded(
                      child: SingleChildScrollView(
                          ...
                          child: Container(
                            ...
                            Padding(padding: getPadding(left: 16, right: 16), child: Text("lbl_provider_name3".tr.toUpperCase(), overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoExtraBold24.copyWith(letterSpacing: 2.88, height: 1.00))),
                            ...
                            CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentySevenController4, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), alignment: Alignment.center),
                            CustomTextFormField(
                                width: 358,
                                focusNode: FocusNode(),
                                controller: controller.frameTwentySixController5,
                                hintText: "msg_provider_name_i".tr,
                                margin: getMargin(left: 16, top: 8, right: 16),
                                variant: TextFormFieldVariant.OutlineGray801,
                                padding: TextFormFieldPadding.PaddingT13,
                                fontStyle: TextFormFieldFontStyle.LatoMedium16Gray800,
                                alignment: Alignment.center,
                                prefix: Container(margin: getMargin(left: 10, top: 10, right: 18, bottom: 10), child: CommonImageView(svgPath: ImageConstant.imgWarning)),
                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                  Padding(
                                      ...
                                      child: Obx(() => ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount: controller.documentsAddNewDocumentsProviderNameErrorFiveModelObj.value.listvectorfour5ItemList.length,
                                          itemBuilder: (context, index) {
                                            Listvectorfour5ItemModel model = controller.documentsAddNewDocumentsProviderNameErrorFiveModelObj.value.listvectorfour5ItemList[index];
                                            return Listvectorfour5ItemWidget(model);
                                          }))),
                                  Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                        ...
                                        CustomTextFormField(width: 96, focusNode: FocusNode(), controller: controller.buttonlargeSixController5, hintText: "lbl_return".tr, variant: TextFormFieldVariant.OutlineBluegray400, padding: TextFormFieldPadding.PaddingTB14, fontStyle: TextFormFieldFontStyle.SFProDisplayRegular165, textInputAction: TextInputAction.done)
                                      ])),
                                  Padding(

...
class Listtrash2ItemWidget extends StatelessWidget {
  Listtrash2ItemWidget(this.listtrash2ItemModelObj);

  Listtrash2ItemModel listtrash2ItemModelObj;

  var controller = Get.find<DocumentsAddNewDocumentsUploadTwelveController>();

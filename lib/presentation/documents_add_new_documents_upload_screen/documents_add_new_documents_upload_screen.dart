...
class DocumentsAddNewDocumentsUploadScreen extends GetWidget<DocumentsAddNewDocumentsUploadController> {
  @override
                  ...
                  Expanded(
                    ...
                    Container(
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                          ...
                          Padding(padding: getPadding(left: 16, top: 36, right: 16), child: Text("msg_added_1_doc".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoBold16Gray800.copyWith(letterSpacing: 1.92, height: 1.00))),
                          Align(
                              ...
                              child: Container(
                                  ...
                                  child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [CustomIconButton(height: 48, width: 48, margin: getMargin(left: 16, top: 16, right: 16, bottom: 250), alignment: Alignment.centerRight, child: CommonImageView(svgPath: ImageConstant.imgTrash))]))),
                          Align(alignment: Alignment.center, child: Padding(padding: getPadding(left: 16, top: 33, right: 16), child: Text("msg_filename1_page".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoRegular16Gray801.copyWith(letterSpacing: 1.92, height: 1.00)))),

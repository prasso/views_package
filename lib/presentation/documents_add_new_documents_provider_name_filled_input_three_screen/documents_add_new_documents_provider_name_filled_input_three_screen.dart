...
class DocumentsAddNewDocumentsProviderNameFilledInputThreeScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameFilledInputThreeController> {
  @override
        ...
        child: Scaffold(
            ...
            body: Container(
                ...
                child: SingleChildScrollView(
                  ...
                  Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 16, top: 20, right: 16), child: Text("lbl_provider_name3".tr.toUpperCase(), overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoExtraBold24.copyWith(letterSpacing: 2.88, height: 1.00)))),
                  Align(alignment: Alignment.centerLeft, child: Padding(padding: getPadding(left: 16, top: 25, right: 16), child: Text("msg_please_enter_pr".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoRegular16.copyWith(letterSpacing: 1.92, height: 1.00)))),
                  CustomTextFormField(
                      width: 358,
                      focusNode: FocusNode(),
                      controller: controller.frameTwentyFourController5,
                      hintText: "lbl_amazon_prime".tr,
                      margin: getMargin(left: 16, top: 18, right: 16),
                      variant: TextFormFieldVariant.OutlineGray800,
                      textInputAction: TextInputAction.done,
                      suffix: Container(margin: getMargin(left: 30, top: 19, right: 16, bottom: 19), child: CommonImageView(svgPath: ImageConstant.imgClose)),
                      suffixConstraints: BoxConstraints(minWidth: getHorizontalSize(17.00), minHeight: getVerticalSize(17.00))),
                  Container(
                      margin: getMargin(left: 16, top: 191, right: 16, bottom: 317),

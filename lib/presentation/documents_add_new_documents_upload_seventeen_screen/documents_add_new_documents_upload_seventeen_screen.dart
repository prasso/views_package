import '../documents_add_new_documents_upload_seventeen_screen/widgets/listtrash4_item_widget.dart';
...
class DocumentsAddNewDocumentsUploadSeventeenScreen extends GetWidget<DocumentsAddNewDocumentsUploadSeventeenController> {
  @override
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                        ...
                        Container(
                            ...
                            child: Obx(() => ListView.builder(
                                ...
                                itemCount: controller.documentsAddNewDocumentsUploadSeventeenModelObj.value.listtrash4ItemList.length,
                                itemBuilder: (context, index) {
                                  Listtrash4ItemModel model = controller.documentsAddNewDocumentsUploadSeventeenModelObj.value.listtrash4ItemList[index];
                                  return Listtrash4ItemWidget(model);
                                }))),

import '../documents_add_new_documents_upload_three_screen/widgets/listtrash_item_widget.dart';
...
class DocumentsAddNewDocumentsUploadThreeScreen extends GetWidget<DocumentsAddNewDocumentsUploadThreeController> {
  @override
                        ...
                        Align(
                            ...
                            child: Container(
                                ...
                                child: Obx(() => ListView.builder(
                                    ...
                                    itemCount: controller.documentsAddNewDocumentsUploadThreeModelObj.value.listtrashItemList.length,
                                    itemBuilder: (context, index) {
                                      ListtrashItemModel model = controller.documentsAddNewDocumentsUploadThreeModelObj.value.listtrashItemList[index];
                                      return ListtrashItemWidget(model);
                                    })))),

import '../documents_add_new_documents_provider_name_error_six_screen/widgets/listvectorfour6_item_widget.dart';
import 'controller/documents_add_new_documents_provider_name_error_six_controller.dart';
import 'models/listvectorfour6_item_model.dart';
...
class DocumentsAddNewDocumentsProviderNameErrorSixScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameErrorSixController> {
                  ...
                  Expanded(
                      child: SingleChildScrollView(
                          ...
                          child: Container(
                            ...
                            CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.egCounterController2, hintText: "lbl_e_g_123456789".tr, margin: getMargin(left: 16, top: 19, right: 16), alignment: Alignment.center),
                            CustomTextFormField(
                                width: 358,
                                focusNode: FocusNode(),
                                controller: controller.frameTwentySixController6,
                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                  Padding(
                                      ...
                                      child: Obx(() => ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount: controller.documentsAddNewDocumentsProviderNameErrorSixModelObj.value.listvectorfour6ItemList.length,
                                          itemBuilder: (context, index) {
                                            Listvectorfour6ItemModel model = controller.documentsAddNewDocumentsProviderNameErrorSixModelObj.value.listvectorfour6ItemList[index];
                                            return Listvectorfour6ItemWidget(model);
                                          }))),
                                  Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                        ...
                                        CustomTextFormField(width: 96, focusNode: FocusNode(), controller: controller.buttonlargeSixController6, hintText: "lbl_return".tr, variant: TextFormFieldVariant.OutlineBluegray400, padding: TextFormFieldPadding.PaddingTB14, fontStyle: TextFormFieldFontStyle.SFProDisplayRegular165, textInputAction: TextInputAction.done)
                                      ])),
                                  Padding(

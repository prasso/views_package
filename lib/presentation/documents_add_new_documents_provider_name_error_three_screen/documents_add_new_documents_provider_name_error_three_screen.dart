import '../documents_add_new_documents_provider_name_error_three_screen/widgets/listvectorfour3_item_widget.dart';
import 'controller/documents_add_new_documents_provider_name_error_three_controller.dart';
import 'models/listvectorfour3_item_model.dart';
...
class DocumentsAddNewDocumentsProviderNameErrorThreeScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameErrorThreeController> {
                  ...
                  Expanded(
                      child: SingleChildScrollView(
                          ...
                          child: Container(
                            ...
                            CustomTextFormField(width: 358, focusNode: FocusNode(), controller: controller.frameTwentySevenController3, hintText: "lbl_e_g_amazon".tr, margin: getMargin(left: 16, top: 18, right: 16), alignment: Alignment.center),
                            CustomTextFormField(
                                width: 358,
                                focusNode: FocusNode(),
                                controller: controller.frameTwentySixController3,
                                ...
                                child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.start, children: [
                                  Padding(
                                      ...
                                      child: Obx(() => ListView.builder(
                                          ...
                                          shrinkWrap: true,
                                          itemCount: controller.documentsAddNewDocumentsProviderNameErrorThreeModelObj.value.listvectorfour3ItemList.length,
                                          itemBuilder: (context, index) {
                                            Listvectorfour3ItemModel model = controller.documentsAddNewDocumentsProviderNameErrorThreeModelObj.value.listvectorfour3ItemList[index];
                                            return Listvectorfour3ItemWidget(model);
                                          }))),
                                  Padding(
                                      ...
                                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                        ...
                                        CustomTextFormField(width: 96, focusNode: FocusNode(), controller: controller.buttonlargeSixController3, hintText: "lbl_return".tr, variant: TextFormFieldVariant.OutlineBluegray400, padding: TextFormFieldPadding.PaddingTB14, fontStyle: TextFormFieldFontStyle.SFProDisplayRegular165, textInputAction: TextInputAction.done)
                                      ])),
                                  Padding(

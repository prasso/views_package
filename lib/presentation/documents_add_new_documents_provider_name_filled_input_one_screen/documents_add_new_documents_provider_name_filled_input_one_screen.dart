...
class DocumentsAddNewDocumentsProviderNameFilledInputOneScreen extends GetWidget<DocumentsAddNewDocumentsProviderNameFilledInputOneController> {
  @override
                  ...
                  Container(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                        ...
                        CustomTextFormField(
                            width: 358,
                            focusNode: FocusNode(),
                            controller: controller.frameTwentyFourController2,
                        ...
                        Align(
                            alignment: Alignment.center,
                            child: Container(
                                margin: getMargin(left: 16, top: 191, right: 16, bottom: 16),

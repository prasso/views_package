...
class DocumentsAddNewDocumentsUploadTwentynineScreen extends GetWidget<DocumentsAddNewDocumentsUploadTwentynineController> {
  @override
                                ...
                                child: Row(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.center, mainAxisSize: MainAxisSize.max, children: [
                                  Container(
                                      ...
                                      child: Stack(alignment: Alignment.centerLeft, children: [
                                        ...
                                        Align(alignment: Alignment.centerLeft, child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(16.00)), child: CommonImageView(imagePath: ImageConstant.imgUpload62, height: getVerticalSize(314.00), width: getHorizontalSize(220.00))))
                                      ])),
                                  Padding(padding: getPadding(left: 16), child: ClipRRect(borderRadius: BorderRadius.circular(getHorizontalSize(16.00)), child: CommonImageView(imagePath: ImageConstant.imgUpload5, height: getVerticalSize(314.00), width: getHorizontalSize(220.00))))
                                ])),
                            Align(alignment: Alignment.center, child: Padding(padding: getPadding(left: 16, top: 32, right: 16), child: Text("msg_position_3".tr, overflow: TextOverflow.ellipsis, textAlign: TextAlign.left, style: AppStyle.txtLatoRegular16Gray801.copyWith(letterSpacing: 1.92, height: 1.00)))),
                            Align(
